...
class TicketPelicula {
    ...
    public function obtenerVentasDiariasPeliculasRango($fechaInicio, $fechaFin) {
        // Consulta SQL para obtener las ventas de películas dentro del rango de fechas
        $sql = "SELECT * FROM ticket_pelicula WHERE DATE(fecha) BETWEEN '$fechaInicio' AND '$fechaFin'";
        $resultado = $this->conexion->conectar()->query($sql);
