<div class="container mt-4">
    ...
    <form method="post" action="./index.php?controller=ProductosController&action=editar">
        ...
        <div class="form-group">
            ...
            <input type="number" name="precio" class="form-control border-0 border-bottom border-primary mb-3" placeholder="Precio del Producto" value="<?php echo $producto['precio']; ?>" required>
        </div>
        <div class="form-group">
            <label for="cantidad_inventario">Cantidad en Inventario:</label>
            <input type="number" name="cantidad_inventario" class="form-control border-0 border-bottom border-primary mb-3" placeholder="Cantidad en Inventario" value="<?php echo $producto['cantidad_inventario']; ?>" required>
        </div>
        <div class="form-group">
